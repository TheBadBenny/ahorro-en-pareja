...
export default function Home() {
  ...
  const annualData = getYearlyCumulative(history, year);
      ...
      <main className="mx-auto max-w-lg px-4 pb-10 pt-4 space-y-4">
        ...
        <Card>
          <CardContent className="p-5 space-y-3">
            ...
            {/* Cumulative area chart - always shows all 12 months */}
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={annualData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                  ...
                  <ReferenceLine
                    ...
                    strokeDasharray="4 4"
                    strokeOpacity={0.5}
                    label={{ value: "40k", position: "right", fontSize: 9, fill: "hsl(155, 70%, 45%)" }}
                  />
                  <Area
                    type="monotone"
                    dataKey="ideal"
